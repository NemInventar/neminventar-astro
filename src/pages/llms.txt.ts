...
export const GET: APIRoute = async ({ site }) => {
  ...
  const lines = [
    ...
    '',
    '## English',
    `- [English overview](${abs('en/')}): Built-in joinery for schools, daycare centres and sports facilities in Denmark — what we make, how we work, documentation and contact.`,
    '',
    '## Kontakt',
